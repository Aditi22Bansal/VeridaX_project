...
notificationSchema.statics.createRoomInvite = function(userId, roomId, inviterId) {
  return this.create({
    userId,
    type: 'room_invite',
...
notificationSchema.statics.createRoomMessage = function(userId, roomId, messageId, senderId) {
  return this.create({
    userId,
    type: 'room_message',
    title: 'New Message',
...
notificationSchema.statics.createRoomMention = function(userId, roomId, messageId, senderId) {
  return this.create({
    userId,
    type: 'room_mention',
...
notificationSchema.statics.createSkillMatch = function(userId, roomId, matchedSkills) {
  return this.create({
    userId,
    type: 'skill_match',
...
notificationSchema.statics.createProjectUpdate = function(userId, campaignId, updateType) {
  return this.create({
    userId,
    type: 'project_update',
