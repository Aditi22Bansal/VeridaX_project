...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    resources: [
      ...
      { name: 'Volunteer Resources', href: '#resources' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">VeridaX</span>
            </Link>

            <p className="text-gray-300 mb-6 max-w-md">
              Empowering communities through AI-led crowdfunding and volunteering.
              Join us in making a difference, one campaign at a time.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="max-w-md">
            ...
            <p className="text-gray-300 mb-4">
              Get the latest news and updates about campaigns and opportunities.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2 text-gray-400">
              <span>© {currentYear} VeridaX. Made with</span>
